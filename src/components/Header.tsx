...
const Header: React.FC = () => {
    ...
    return (
        <header
            className={`text-white py-3 px-16 fixed w-full top-0 z-50 select-none ${
                isDashbaordRoute ? "border-b border-white/15 bg-neutral-950" : "mt-2"
            }`}
        >
                        ...
                        {!isDashbaordRoute ? (
                            <div className="flex items-center space-x-5">
                                ...
                                <button
                                    ...
                                    className="group flex cursor-pointer items-center gap-3 py-1.5 px-3 rounded-full border border-white/10 hover:border-white/20 bg-gradient-to-b from-white/5 to-white/[0.02] hover:from-white/10 hover:to-white/[0.05] transition-all duration-200"
                                >
                                ...
                                {isDropdownOpen && (
                                    <div className="absolute right-0 mt-2 w-56 py-2 bg-neutral-900 backdrop-blur-xl rounded-xl border border-white/10 shadow-xl">
                                        ...
                                        <div className="py-1.5">
                                            <button className="w-full flex items-center gap-3 px-4 py-2 text-sm text-white/60 hover:text-white transition-colors hover:bg-white/[0.06]">
                                                <Settings size={15} />
                                                Settings
                                            </button>
                                            <button
                                                onClick={handleLogout}
                                                className="w-full flex items-center gap-3 px-4 py-2 text-sm text-white/60 hover:text-red-400 transition-colors hover:bg-white/[0.06]"
                                            >
                                                <LogOut size={15} />
                                                Sign Out
                                            </button>
