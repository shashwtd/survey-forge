  ...
  return (
    <div className="w-full max-w-sm mx-auto space-y-8">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-semibold tracking-tight text-white font-instrument-sans">Welcome back</h1>
        <p className="text-base text-white/60">Sign in to your account to continue</p>
      </div>

      <div className="space-y-6">
        <SlackAuthButton mode="signin" />
        ...
        <form className="space-y-5" onChange={handleFormChange}>
