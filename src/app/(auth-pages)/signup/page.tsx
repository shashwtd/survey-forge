  ...
  return (
    <>
      <div className="space-y-1.5 mb-6">
        <h1 className="text-2xl font-semibold tracking-tight text-white font-instrument-sans">Create an account</h1>
      ...
      <form className="space-y-4" onChange={handleFormChange}>
        ...
        <div className="flex flex-col space-y-1">
          <label htmlFor="password" className="text-sm font-medium leading-none text-white/75 tracking-wide">
            Password
          </label>
